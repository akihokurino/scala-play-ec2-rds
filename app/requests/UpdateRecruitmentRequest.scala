...
case class UpdateRecruitmentRequest(displayOccupationId: Int,
...
object UpdateRecruitmentRequest {
  ...
  )(UpdateRecruitmentRequest.apply)(UpdateRecruitmentRequest.unapply))
}